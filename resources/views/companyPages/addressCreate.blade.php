...
<section class="content-header">
	<h1>
		...
		<small>add your company's address</small>
	</h1>
	<ol class="breadcrumb">
		...
		<div class="box-body">
			...
			<form action="{{ route('address.store') }}" method="post" class="form-horizontal">
				...
				<div class="form-group{{ $errors->has('phone1') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="text" class="form-control pull-right" id="phone1" name="phone1" placeholder="Primary Phone" value="{{old('phone1')}}">
					</div>
				</div>
				...
				<div class="form-group{{ $errors->has('phone2') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="text" class="form-control pull-right" id="phone2" name="phone2" placeholder="Secondary Phone" value="{{old('phone2')}}">
					</div>
				</div>
				...
				<div class="form-group{{ $errors->has('website') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input type="text" class="form-control pull-right" id="website" name="website" placeholder="Website Link" value="{{old('website')}}">
					</div>
				</div>
